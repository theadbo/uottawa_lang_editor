...
Drupal.behaviors.metatagFrenchFieldsetSummaries = {
  attach: function (context) {
    $('fieldset.metatags-form-french', context).drupalSetSummary(function (context) {
      var vals = [];
      $("input[type='text'], select, textarea", context).each(function() {
        var default_name = $(this).attr('name').replace(/\[value\]/, '[default_french]');
